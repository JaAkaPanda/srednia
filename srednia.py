answer = 1
while answer != "0":
        answer = (input('Which type of average would you like to calculate? (Enter "1" for arythmetic average or "2" for weight average or "0" to close): '))
        if answer == "0":
            print("Program closed. Goodbye!")
        elif answer != "1" and answer != "2" and answer != "0":
